...
const cwd = process.cwd(),
	{stratagems, version: hd2version} = JSON5.parse(readFileSync(path.join(cwd,"..","helpPage","src","stratagems.json5")).toString("utf8")),
	...
	exampleCode = readFileSync(path.join(cwd,"..","helpPage","src","example.ahk")).toString("utf8"),
