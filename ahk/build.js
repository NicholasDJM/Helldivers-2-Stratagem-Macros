...
const cwd = process.cwd(),
	{stratagems, hd2version} = JSON5.parse(readFileSync(path.join(cwd,"..","helpPage","src","stratagems.json5")).toString("utf8")),
	...
	html = readFileSync(path.join(cwd,"..","helpPage","dist","index.html")).toString("utf8").replaceAll("`", "``") // Must escape backticks.
