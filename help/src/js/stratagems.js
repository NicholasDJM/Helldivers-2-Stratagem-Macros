...
/* TODO
	Several stratagems are missing icons. See below
*/
 ...
 * @type {Version}
 */
export const version = "release/01.002.101/13887",
	/**
	...
	stratagems = [
		...
		// -------------------------------------------------------------------
		{
			...
			icon: wiki + "/e/e0/Machine_Gun_Stratagem_Icon.png",
			modelName: "MG-43",
		...
		},
		{
			...
			type: ["weapon"],
			icon: wiki + "/3/3c/Anti-Materiel_Rifle_Stratagem_Icon.png",
			modelName: "APW-1",
		...
		},
		{
			key: "Stalwart",
			type: ["weapon", "machine gun"],
			icon: wiki + "/4/46/Stalwart_Stratagem_Icon.png",
			modelName: "M-105",
		...
		},
		{
			...
			type: ["weapon"],
			icon: wiki + "/1/1c/Expendable_Anti-Tank_Stratagem_Icon.png",
			modelName: "EAT-17",
		...
		},
		{
			...
			icon: wiki + "/7/70/Recoilless_Rifle_Stratagem_Icon.png",
			modelName: "GR-8",
		...
		},
		{
			key: "Flamethrower",
			type: ["weapon"],
			icon: wiki + "/7/75/Flamethrower_Stratagem_Icon.png",
			modelName: "FLAM-40",
		...
		},
		{
			key: "Autocannon",
			type: ["weapon", "backpack", "team reload"],
			icon: wiki + "/e/ef/Autocannon_Stratagem_Icon.png",
			modelName: "AC-8",
		...
		},
		{
			...
			type: ["weapon", "machine gun"],
			icon: wiki + "/d/d9/Heavy_Machine_Gun_Stratagem_Icon.png",
			modelName: "MG-206",
		...
		},
		{
			...
			icon:
				wiki +
				"/a/ad/RL-77_Airburst_Rocket_Launcher_Stratagem_Icon.png",
			modelName: "RL-77",
		...
		},
		{
			key: "Commando",
			type: ["weapon"],
			icon: wiki + "/7/78/Commando_Stratagem_Icon.png",
			modelName: "MLS-4X",
		...
		},
		{
			key: "Railgun",
			type: ["weapon"],
			icon: wiki + "/3/35/Railgun_Stratagem_Icon.png",
			modelName: "RS-422",
		...
		},
		{
			key: "Spear",
			type: ["weapon", "backpack", "team reload"],
			icon: wiki + "/5/54/Spear_Stratagem_Icon.png",
			modelName: "FAF-14",
		...
		},
		{
			...
			type: ["weapon"],
			icon: wiki + "/c/cf/Grenade_Launcher_Stratagem_Icon.png",
			modelName: "GL-22",
		...
		},
		{
			key: "Laser Cannon",
			type: ["weapon", "laser"],
			icon: wiki + "/c/c3/Laser_Cannon_Stratagem_Icon.png",
			modelName: "LAS-98",
		...
		},
		{
			key: "Arc Thrower",
			type: ["weapon"],
			icon: wiki + "/1/10/Arc_Thrower_Stratagem_Icon.png",
			modelName: "ARC-3",
		...
		},
		{
			key: "Quasar Cannon",
			type: ["weapon"],
			icon: wiki + "/8/87/Quasar_Cannon_Stratagem_Icon.png",
			modelName: "LAS-99",
		...
		},
		{
			key: "Sterilizer",
			type: ["weapon"],
			icon: wiki + "/2/29/Sterilizer_Stratagem_Icon.png",
			modelName: "TX-41",
		...
		// -------------------------------------------------------------------
		{
			...
			type: ["orbital"],
			icon: wiki + "/f/f6/Orbital_Gatling_Barrage_Stratagem_Icon.png",
			code: ["right", "down", "left", "up", "up"],
		},
		{
			key: "Orbital Airburst Strike",
			type: ["orbital"],
			icon: wiki + "/2/28/Orbital_Airburst_Strike_Stratagem_Icon.png",
			code: ["right", "right", "right"],
		},
		{
			key: "Orbital 120mm HE Barrage",
			type: ["orbital"],
			icon: wiki + "/4/40/Orbital_120mm_HE_Barrage_Stratagem_Icon.png",
			code: ["right", "right", "down", "left", "right", "down"],
		},
		{
			key: "Orbital 380mm HE Barrage",
			type: ["orbital"],
			icon: wiki + "/1/12/Orbital_380mm_HE_Barrage_Stratagem_Icon.png",
			code: ["right", "down", "up", "up", "left", "down", "down"],
		},
		{
			key: "Orbital Walking Barrage",
			type: ["orbital"],
			icon: wiki + "/5/53/Orbital_Walking_Barrage_Stratagem_Icon.png",
			code: ["right", "down", "right", "down", "right", "down"],
		},
		{
			key: "Orbital Laser",
			type: ["orbital", "laser"],
			icon: wiki + "/d/d8/Orbital_Laser_Stratagem_Icon.png",
			code: ["right", "down", "up", "right", "down"],
		},
		{
			key: "Orbital Railcannon Strike",
			type: ["orbital"],
			icon: wiki + "/6/6f/Orbital_Railcannon_Strike_Stratagem_Icon.png",
			code: ["right", "up", "down", "down", "right"],
		},
		{
			key: "Orbital Precision Strike",
			type: ["orbital"],
			icon: wiki + "/2/2a/Orbital_Precision_Strike_Stratagem_Icon.png",
			code: ["right", "right", "down"],
		},
		{
			key: "Orbital Gas Strike",
			type: ["orbital", "toxic"],
			icon: wiki + "/c/cd/Orbital_Gas_Strike_Stratagem_Icon.png",
			code: ["right", "right", "down", "right"],
		},
		{
			key: "Orbital Smoke Strike",
			type: ["orbital"],
			icon: wiki + "/b/bc/Orbital_Smoke_Strike_Stratagem_Icon.png",
			code: ["right", "right", "down", "up"],
		},
		{
			key: "Orbital EMS Strike",
			type: ["orbital"],
			icon: wiki + "/1/16/Orbital_EMS_Strike_Stratagem_Icon.png",
			code: ["right", "right", "left", "down"],
		},
		{
			key: "Orbital Napalm Barrage",
			type: ["orbital", "fire"],
			icon: wiki + "/9/97/Orbital_Napalm_Barrage_Stratagem_Icon.png",
		...
		// -------------------------------------------------------------------
		{
			...
			type: ["eagle"],
			icon: wiki + "/f/f3/Eagle_Strafing_Run_Stratagem_Icon.png",
			code: ["up", "right", "right"],
		},
		{
			key: "Eagle Airstrike",
			type: ["eagle"],
			icon: wiki + "/7/72/Eagle_Airstrike_Stratagem_Icon.png",
			code: ["up", "right", "down", "right"],
		},
		{
			key: "Eagle Cluster Bomb",
			type: ["eagle"],
			icon: wiki + "/4/4f/Eagle_Cluster_Bomb_Stratagem_Icon.png",
			code: ["up", "right", "down", "down", "right"],
		},
		{
			key: "Eagle Napalm Strike",
			type: ["eagle", "fire"],
			icon: wiki + "/4/42/Eagle_Napalm_Airstrike_Stratagem_Icon.png",
			code: ["up", "right", "down", "up"],
		},
		{
			key: "Eagle Smoke Strike",
			type: ["eagle"],
			icon: wiki + "/0/05/Eagle_Smoke_Strike_Stratagem_Icon.png",
			code: ["up", "right", "up", "down"],
		},
		{
			key: "Eagle 110mm Rocket Pods",
			type: ["eagle"],
			icon: wiki + "/e/ef/Eagle_110mm_Rocket_Pods_Stratagem_Icon.png",
			code: ["up", "right", "up", "left"],
		},
		{
			key: "Eagle 500kg Bomb",
			type: ["eagle"],
			icon: wiki + "/e/e5/Eagle_500kg_Bomb_Stratagem_Icon.png",
		...
		// -------------------------------------------------------------------
		{
			key: "Jump Pack",
			type: ["backpack"],
			icon: wiki + "/f/f5/Jump_Pack_Stratagem_Icon.png",
			modelName: "LIFT-850",
		...
		},
		{
			key: "Supply Pack",
			type: ["backpack"],
			icon: wiki + "/6/61/Supply_Pack_Stratagem_Icon.png",
			modelName: "B-1",
		...
		},
		{
			...
			icon: wiki + "/6/6f/Guard_Dog_Rover_Stratagem_Icon.png",
			modelName: "AX/LAS-5",
		...
		},
		{
			...
			icon: wiki + "/7/73/Guard_Dog_Stratagem_Icon.png",
			modelName: "AX/AR-23",
		...
		},
		{
			...
			icon: wiki + "/2/20/Guard_Dog_Dog_Breath_Stratagem_Icon.png",
			modelName: "AX/TX-13",
		...
		},
		{
			...
			type: ["backpack"],
			icon: wiki + "/3/37/Ballistic_Shield_Backpack_Stratagem_Icon.png",
			modelName: "SH-20",
		...
		},
		{
			...
			type: ["backpack"],
			icon: wiki + "/9/99/Shield_Generator_Pack_Stratagem_Icon.png",
			modelName: "SH-32",
		...
		// -------------------------------------------------------------------
		{
			...
			icon: wiki + "/e/e4/Shield_Generator_Relay_Stratagem_Icon.png",
			modelName: "FX-12",
		...
		},
		{
			key: "Tesla Tower",
			type: ["defense", "emplacement"],
			icon: wiki + "/8/8f/Tesla_Tower_Stratagem_Icon.png",
			modelName: "A/ARC-3",
		...
		},
		{
			...
			icon: wiki + "/b/bb/Anti-Personnel_Minefield_Stratagem_Icon.png",
			modelName: "MD-6",
		...
		},
		{
			...
			icon: wiki + "/a/a9/Incendiary_Minefield_Stratagem_Icon.png",
			modelName: "MD-14",
		...
		},
		{
			key: "Anti-Tank Mines",
			type: ["defense", "emplacement", "mines"],
			icon: wiki + "/b/ba/MD-17_Anti-Tank_Mines_Stratagem_Icon.png",
			modelName: "MD-17",
		...
		},
		{
			...
			type: ["defense", "emplacement", "mines"],
			modelName: "MD-8",
			icon: wiki + "/c/c0/Gas_Minefield_Stratagem_Icon.png.png",
			code: ["down", "left", "left", "right"],
		},
		{
			key: "HMG Emplacement",
			type: ["defense", "emplacement"],
			icon: wiki + "/0/03/HMG_Emplacement_Stratagem_Icon.png",
			modelName: "E/MG-101",
		...
		},
		{
			...
			type: ["defense", "sentry"],
			icon: wiki + "/5/5a/Machine_Gun_Sentry_Stratagem_Icon.png",
			modelName: "A/MG-43",
		...
		},
		{
			key: "Gatling Sentry",
			type: ["defense", "sentry"],
			icon: wiki + "/2/28/Gatling_Sentry_Stratagem_Icon.png",
			modelName: "A/G-16",
		...
		},
		{
			key: "Mortar Sentry",
			type: ["defense", "sentry"],
			icon: wiki + "/a/ad/Mortar_Sentry_Stratagem_Icon.png",
			modelName: "A/M-12",
		...
		},
		{
			...
			type: ["defense", "sentry"],
			icon: wiki + "/a/a7/Autocannon_Sentry_Stratagem_Icon.png",
			modelName: "A/AC-8",
		...
		},
		{
			key: "Rocket Sentry",
			type: ["defense", "sentry"],
			icon: wiki + "/6/62/Rocket_Sentry_Stratagem_Icon.png",
			modelName: "A/MLS-4X",
		...
		},
		{
			...
			type: ["defense", "sentry"],
			icon: wiki + "/a/a8/AM-23_EMS_Mortar_Sentry_Stratagem_Icon.png",
			modelName: "A/M-23",
		...
		// -------------------------------------------------------------------
		{
			key: "Patriot Exosuit",
			type: ["vehicle", "mech"],
			icon: wiki + "/3/30/EXO-45_Patriot_Exosuit_Stratagem_Icon.png",
			modelName: "EXO-45",
		...
		},
		{
			...
			type: ["vehicle", "mech"],
			icon: wiki + "/8/82/EXO-49_Emancipator_Exosuit_Stratagem_Icon.png",
			modelName: "EXO-49",
		...
		// -------------------------------------------------------------------
		{
			key: "Reinforce",
			type: ["mission"],
			icon: wiki + "/5/5c/Reinforce_Stratagem_Icon.png",
			code: ["up", "down", "right", "left", "up"],
		},
		{
			key: "SOS Beacon",
			type: ["mission"],
			icon: wiki + "/3/3d/SOS_Beacon_Stratagem_Icon.png",
			code: ["up", "down", "right", "up"],
		},
		{
			key: "Resupply",
			type: ["mission"],
			icon: wiki + "/6/64/Resupply_Stratagem_Icon.png",
			code: ["down", "down", "up", "right"],
		},
		{
			key: "Eagle Rearm",
			type: ["mission", "eagle"],
			icon: wiki + "/0/08/Eagle_Rearm_Stratagem_Icon.png",
		...
		},
		{
			...
			key: "SSSD Delivery",
			type: ["mission"],
			icon: wiki + "/5/53/Start_Upload_Stratagem_Icon.svg",
		...
		},
		{
			...
			type: ["mission"],
			icon: wiki + "/0/02/Prospecting_Drill_Stratagem_Icon.png",
			code: ["down", "down", "left", "right", "down", "down"],
		},
		{
			key: "Super Earth Flag",
			type: ["mission"],
			icon: wiki + "/3/3c/Super_Earth_Flag_Stratagem_Icon.png",
			code: ["down", "up", "down", "up"],
		},
		{
			key: "Hellbomb",
			type: ["mission"],
			icon: wiki + "/a/a0/Hellbomb_Stratagem_Icon.png",
		...
		},
		{
			key: "Seismic Probe",
			type: ["mission"],
			icon: wiki + "/7/74/Seismic_Probe_Stratagem_Icon.png",
			code: ["up", "up", "left", "right", "down", "down"],
		},
		{
			key: "SEAF Artillery",
			type: ["mission"],
			icon: wiki + "/f/f7/SEAF_Artillery_Stratagem_Icon.png",
			code: ["right", "up", "up", "down"],
		},
		{
			key: "Orbital Illumination Flare",
			type: ["mission"],
			icon: wiki + "/f/f9/Orbital_Illumination_Flare_Stratagem_Icon.png",
			code: ["right", "right", "left", "left"],
		},
		{
			// Helldivers Wiki doesn't have this stratagem's icon, as of December 2024.
			key: "Dark Fluid Vessel",
			type: ["mission", "backpack"],
			code: ["up", "left", "right", "down", "up", "up"],
		},
		{
			// TODO: This Stratagem's icon does not have it's own icon documented by the Helldivers Wiki, so we're using another stratagem's icon.
			key: "Tectonic Drill",
			type: ["mission"],
			icon: wiki + "/0/02/Prospecting_Drill_Stratagem_Icon.png",
