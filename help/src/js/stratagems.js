...
export const version = "01.001.005",
	 ...
	 * Each one has a `code` property, a series of direction inputs, which is used to generate Case statements in the AutoHotkey script.
	...
	stratagems = [
		// Weapons
		{ key: "Machine Gun", type: ["weapon"], icon: wiki+"/e/e0/Machine_Gun_Stratagem_Icon.png", code: ["down","left","down","up","right"] },
		...
		{ key: "Recoilless Rifle", type: ["weapon", "backpack"], icon: wiki+"/7/70/Recoilless_Rifle_Stratagem_Icon.png", code: ["down","left","right","right","left"] },
		{ key: "Flamethrower", type: ["weapon"], icon: wiki+"/7/75/Flamethrower_Stratagem_Icon.png", code: ["down","left","up","down","up"] },
		{ key: "Autocannon", type: ["weapon", "backpack"], icon: wiki+"/e/ef/Autocannon_Stratagem_Icon.png", code: ["down","left","down","up","up","right"] },
		{ key: "Heavy Machine Gun", type: ["weapon"], icon: wiki+"/d/d9/Heavy_Machine_Gun_Stratagem_Icon.png", code: ["down","left","up","down","down"] },
		{ key: "Airburst Rocket Launcher", type: ["weapon", "backpack"], icon: wiki+"/a/ad/RL-77_Airburst_Rocket_Launcher_Stratagem_Icon.png", code: ["down","up","up","left","right"] },
		...
		{ key: "Spear", type: ["weapon", "backpack"], icon: wiki+"/5/54/Spear_Stratagem_Icon.png", code: ["down","down","up","down","down"] },
		...
		*/
		...
		{ key: "Eagle Napalm Strike", type: ["eagle"], icon: wiki+"/4/42/Eagle_Napalm_Airstrike_Stratagem_Icon.png", code: ["up","right","down","up"] },
		...
		{ key: "Guard Dog Rover", type: ["backpack","laser"], icon: wiki+"/6/6f/Guard_Dog_Rover_Stratagem_Icon.png", code: ["down","up","left","up","right","right"] },
		{ key: "Guard Dog", type: ["backpack"], icon: wiki+"/7/73/Guard_Dog_Stratagem_Icon.png", code: ["down","up","left","up","right","down"] },
		...
		// Defense
		{ key: "Shield Generator Relay", type: ["defense"], icon: wiki+"/e/e4/Shield_Generator_Relay_Stratagem_Icon.png", code: ["down","down","left","right","left","right"] },
		{ key: "Tesla Tower", type: ["defense"], icon: wiki+"/8/8f/Tesla_Tower_Stratagem_Icon.png", code: ["down","up","right","up","left","right"] },
		{ key: "Anti-Personnel Minefield", type: ["defense"], icon: wiki+"/b/bb/Anti-Personnel_Minefield_Stratagem_Icon.png", code: ["down","left","up","right"] },
		{ key: "Incendiary Mines", type: ["defense"], icon: wiki+"/a/a9/Incendiary_Minefield_Stratagem_Icon.png", code: ["down","left","left","down"] },
		{ key: "Anti-Tank Mines", type: ["defense"], icon: wiki+"/b/ba/MD-17_Anti-Tank_Mines_Stratagem_Icon.png", code: ["down","left","up","up"] },
		{ key: "HMG Emplacement", type: ["defense"], icon: wiki+"/0/03/HMG_Emplacement_Stratagem_Icon.png", code: ["down","up","left","right","right","left"] },
		{ key: "Machine Gun Sentry", type: ["defense"], icon: wiki+"/5/5a/Machine_Gun_Sentry_Stratagem_Icon.png", code: ["down","up","right","right","up"] },
		{ key: "Gatling Sentry", type: ["defense"], icon: wiki+"/2/28/Gatling_Sentry_Stratagem_Icon.png", code: ["down","up","right","left"] },
		{ key: "Mortar Sentry", type: ["defense"], icon: wiki+"/a/ad/Mortar_Sentry_Stratagem_Icon.png", code: ["down","up","right","right","down"] },
		{ key: "Autocannon Sentry", type: ["defense"], icon: wiki+"/a/a7/Autocannon_Sentry_Stratagem_Icon.png", code: ["down","up","right","up","left","up"] },
		{ key: "Rocket Sentry", type: ["defense"], icon: wiki+"/6/62/Rocket_Sentry_Stratagem_Icon.png", code: ["down","up","right","right","left"] },
		{ key: "EMS Mortar Sentry", type: ["defense"], icon: wiki+"/a/a8/AM-23_EMS_Mortar_Sentry_Stratagem_Icon.png", code: ["down","up","right","down","right"] },
		...
		{ key: "Super Earth Flag", type: ["mission"], icon: wiki+"/3/3c/Super_Earth_Flag_Stratagem_Icon.png", code: ["up","down","up","down"] },
