...
// Generate a hash of the files, to be later used by the auto update process to determine if we need to update the macro script.
const file = `../dist/Helldivers 2 Macros.${langLong}.ahk`,
	updateFile = "../dist/updates.txt";
/** @type {string} */
const hashed = hash("md5", file),
	contents = (existsSync(updateFile) ? read(updateFile) : "").split(EOL)
...
copyFile("../help/dist/index.html", `../docs/${langLong}.html`, (/** @type {any} */ error) => {
